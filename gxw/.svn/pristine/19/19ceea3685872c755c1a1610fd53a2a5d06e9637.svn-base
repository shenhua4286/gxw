...
var artDialog = function (config, ok, cancel) {
	...
	art.gxw_API = art.gxw_API || [];
     var that_Api = art.gxw_API[config.id];
...
artDialog.fn = artDialog.prototype = {
	...
	content: function (msg,url) {
		...
		if (typeof msg === 'string') {
			...
			if (isIframe) art.gxw_API[that.config.id] = msg.contentWindow
		};
...
+				'<td class="aui_c">'
+					'<div class="aui_inner">'
+					'<table class="aui_dialog" style="width:720px">'
+						'<tbody>'
+							'<tr>'
