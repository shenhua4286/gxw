...
$LANG['test'] = 'Test';
$LANG['url_msg'] = '(For example, http://www.gxw.cn/help/rumen/(*).html. Use <a href="javascript:insertText(\'urlpage_1\', \'(*)\')">(*)</a>as a wildcard.';
...
$LANG['nextpage_rule_msg'] = 'Please input the code of Next page Hyperlink. For example, <a href="http://www.gxw.cn/page_1.html"> Next page</a>, “Next page rule” is “Next page”';
