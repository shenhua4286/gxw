DROP TABLE IF EXISTS `gxw_comment_setting`;
CREATE TABLE IF NOT EXISTS `gxw_comment_setting` (
...
INSERT INTO `gxw_comment_setting` (`siteid`, `guest`, `check`, `code`, `add_point`, `del_point`) VALUES (1, 0, 0, 0, 0, 0);
