...
$LANG['plugin_be_locked'] = '应用被锁定,请联系gxw';
...
$LANG['plugin_copyright_info'] = '&copy; CopyRight 2005-2014 湖南星通科技有限公司 B2-20040053';
...
$LANG['plugin_debug_tips'] = '您目前的开发模式为调试模式，关闭调试模式请设置configs\system.php中plugin_debug为0,<a href="http://help.open.gxw.cn/2011/developer_0530/330.html" target="_blank">详细>></a>';
?>