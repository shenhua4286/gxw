...
$LANG['between_2_to_40'] = '应该为2-40位之间';
$LANG['between_2_to_50'] = '应该为2-50位之间';
...
$LANG['userid_banned_by_administrator'] = '您的企业组为禁止访问';
...
$LANG['buy_point'] = '购买积分';
$LANG['point'] = '积分点数';
$LANG['point_notice'] = '，积分点数将影响企业用户组';
$LANG['changegroup_notice'] = '非vip企业用户组与积分绑定，如只修改企业组请设置该企业为vip';
$LANG['lock'] = '锁定';
...
$LANG['forget_password_notice'] = '提交后请在一小时内登录邮箱重置企业密码。';
$LANG['or'] = '或';
$LANG['remember'] = '记住';
$LANG['vip'] = 'vip企业';
$LANG['isvip'] = '是否为vip企业';
$LANG['plsease_select'] = '请选择';
$LANG['member_group'] = '用户属性';
$LANG['ignore'] = '忽略';
$LANG['reject'] = '拒绝';
$LANG['modelinfo'] = '模型资料';
...
$LANG['allowpostnum'] = '日最大录入数';
$LANG['zero_nolimit'] = '0为不限制';
$LANG['allowpostnum_deny'] = '今日录入已超过限制数';
...
$LANG['allowpostverify'] = '录入审核';
$LANG['allowsendmessage'] = '发短消息';
$LANG['message'] = '短消息';
$LANG['upgrade_price'] = '企业资费';
$LANG['price_y'] = '包年价格';
$LANG['price_m'] = '包月价格';
$LANG['price_d'] = '包天价格';
$LANG['need'] = '需要';
...
$LANG['allow_register'] = '允许新企业注册';
$LANG['register_model'] = '注册选择模型';
$LANG['need_more_memberinfo'] = '请填写企业详细信息';
$LANG['register_email_auth'] = '新企业注册需要邮件验证';
$LANG['enablemailcheck_notice'] = '需填写邮箱配置，开启后企业注册审核功能无效';
$LANG['allow_memberlist'] = '允许前台浏览企业列表';
$LANG['register_verify'] = '新企业注册需要管理员审核';
$LANG['administrator'] = '管理员';
$LANG['member_verifycode'] = '企业注册启用验证码功能';
$LANG['click_change_validate'] = '点击更换验证码';
$LANG['upgrade_method'] = '企业升级付费方式';
$LANG['defualtpoint'] = '新企业默认点数';
$LANG['defualtamount'] = '新企业注册默认赠送资金';
$LANG['register_protocol'] = '企业注册协议';
$LANG['show_register_protocol'] = '是否显示注册协议';
$LANG['show_app_point'] = '是否启用应用间积分兑换';
$LANG['rmb_point_rate'] = '1元人民币购买积分数量';

$LANG['member_totalnum'] = '企业总数';
$LANG['register'] = '注册';
$LANG['register_notice'] = '更改企业模型会刷新页面，请首先选择企业模型。';
$LANG['success'] = '成功';
$LANG['agree'] = '同意';
$LANG['notice'] = '注意';
$LANG['member_verify_totalnum'] = '待审核企业数';
$LANG['nolimit'] = '无限制';
$LANG['member_search'] = '搜索企业';
$LANG['member_vip_totalnum'] = 'vip企业数';
$LANG['member_research'] = '重新搜索';
$LANG['normal'] = '正常';
$LANG['member_statistics'] = '企业统计';
$LANG['member_todaynum'] = '今日新增';
$LANG['normal'] = '正常';
$LANG['please_click'] = '请点击';
$LANG['reg_verify_email'] = '注册企业验证邮件';
$LANG['invalid_appid'] = '应用未通过盛大验证，请联系管理员';

$LANG['model_name'] = '模型名称';
$LANG['all_site'] = '所有站点';
$LANG['belong_to_site'] = '是否为公共模型';
$LANG['site_have_no_model'] = '站点无企业模型';
$LANG['model_import'] = '导入模型';
$LANG['member_model_add'] = '添加企业模型';
$LANG['member_model'] = '企业模型';
...
$LANG['please_login'] = '您需要登录才能进行下一步操作，请先登录';
$LANG['overdue'] = '已过期';
...
$LANG['move_member_model_alert'] = '移动模型企业，将会把原有模型里的企业信息删除，不能修复。';
$LANG['move_member_model_index_alert'] = '1、请谨慎删除模型，当模型里存在企业时请使用“移动”功能将该模型里的企业移动到其他企业模型中。<br />2、移动模型企业，将会把原有模型里的企业信息删除，将不能修复。 ';
...
$LANG['deny_set_field_group'] = '禁止设置字段值的企业组';
$LANG['deny_set_field_role'] = '禁止设置字段值的角色';
$LANG['points_less_than'] = '您的积分为<font color="red">{point}</font>点，发布录入需要扣除<font color="red">{need_point}</font>点，您可以通过回复评论来获取积分';
$LANG['contributors_checked'] = '添加成功，请等待审核';
$LANG['contributors_success'] = '添加成功';
$LANG['has_been_verified'] = '系统不允许再次修改！';
$LANG['contribute_del_point'] = '录入扣点';
...
$LANG['deny_upgrade'] = '您所在的企业组禁止自主升级';
...
$LANG['sina_login_notice'] = '使用新浪微博连接登录gxw,将精彩内容分享到新浪微博。';
$LANG['qq_login_notice'] = '使用腾讯微博连接登录gxw,将精彩内容分享到腾讯微博。';
$LANG['snda_login_notice'] = '使用用盛大连接登录gxw,轻松使用盛大所有服务。';
