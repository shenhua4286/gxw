DROP TABLE IF EXISTS `gxw_poster_space`;
CREATE TABLE IF NOT EXISTS `gxw_poster_space` (
...
INSERT INTO `gxw_poster_space` (`siteid`, `spaceid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
(1, 1, '顶部搜索右侧广告位', 'banner', 'poster_js/1.js', 430, 63, 'array (\n  ''paddleft'' => '''',\n  ''paddtop'' => '''',\n)', '', 1, 0);
INSERT INTO `gxw_poster_space` (`siteid`, `spaceid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
(1, 2, '企业登陆页广告', 'banner', 'poster_js/2.js', 310, 304, 'array (\n  ''paddleft'' => '''',\n  ''paddtop'' => '''',\n)', '企业登陆页广告右侧代替外部通行证广告', 1, 0);
INSERT INTO `gxw_poster_space` (`siteid`, `spaceid`, `name`, `type`, `path`, `width`, `height`, `setting`, `description`, `items`, `disabled`) VALUES
