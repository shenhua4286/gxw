...
$link_db->insert(array('siteid'=>1,'typeid'=>$typeid,'linktype'=>'1','name'=>'gxw','url'=>'http://www.gxw.cn','logo'=>'http://www.gxw.cn/images/logo_88_31.gif','passed'=>1,'addtime'=>SYS_TIME)); 
