 ...
 */
$LANG ['member_manage'] = '管理企业';
$LANG ['member_add'] = '添加企业';
$LANG ['member_编辑'] = '编辑企业';
$LANG ['member_verify'] = '待审核企业(系统)';
$LANG ['member_group_manage'] = '企业组管理';
$LANG ['member_model'] = '企业模型管理';
$LANG ['member_group_add'] = '添加企业组';
$LANG ['member_model_add'] = '添加企业模型';
$LANG ['member_model_import'] = '导入企业模型';
$LANG ['members'] = '用户管理';
$LANG ['member_group_manage'] = '管理企业组';
$LANG ['member_model_manage'] = '管理企业模型';
$LANG ['manage_member'] = '用户管理';
$LANG ['manage_member_group'] = '企业组管理';
$LANG ['manage_member_model'] = '企业模型管理';
$LANG ['menu_add'] = '添加菜单';
$LANG ['site_编辑'] = '编辑站点';
$LANG ['site_del'] = '删除站点';
$LANG ['add_site'] = '添加站点';
...
$LANG ['member_lock'] = '锁定企业';
$LANG ['member_unlock'] = '解锁企业';
$LANG ['member_move'] = '移动企业';
$LANG ['member_delete'] = '删除企业';
$LANG ['memebr_verify'] = '待审核企业';
$LANG ['template_file_list'] = '模板文件列表';
$LANG ['template_file_编辑'] = '模板文件编辑';
$LANG ['member_setting'] = '企业模块配置';
$LANG ['basic_setting'] = '基本配置';
$LANG ['title_setting'] = '组头衔管理';
$LANG ['verify_pass'] = '已通过列表';
$LANG ['ignore'] = '忽略列表';
$LANG ['verify_deny'] = '其他企业';
$LANG ['verify_ignore'] = '忽略列表';
$LANG ['verify_delete'] = '已删除用户管理';
$LANG ['verify_deny'] = '其他企业';
...
$LANG ['linkage'] = '联动菜单';
$LANG ['special'] = '专题';
$LANG ['template_编辑or'] = '模板编辑';
$LANG ['template_visualization'] = '模板可视化';
$LANG ['pc_tag_编辑'] = '编辑PC标签';
...
$LANG ['correlative_setting'] = '相关权限设置';
$LANG ['vote_setting'] = '投票配置';
$LANG ['queue_del'] = '删除消息';
$LANG ['admin_manage'] = '管理员管理';
$LANG ['member_model_delete'] = '删除企业模型';
$LANG ['member_model_编辑'] = '修改企业模型';
$LANG ['link'] = '友情链接';
$LANG ['comment'] = '评论';
$LANG ['workflow'] = '工作流';
...
$LANG ['member_modelfield_add'] = '添加企业模型字段';
$LANG ['member_modelfield_编辑'] = '编辑企业模型字段';
$LANG ['member_modelfield_delete'] = '删除企业模型字段';
$LANG ['member_modelfield_manage'] = '企业模型字段管理';
...
$LANG ['position_编辑'] = '编辑推荐位';
$LANG ['collection_node_编辑'] = '编辑采集点';
...
$LANG ['content_settings'] = '内容相关权限设置';
...
$LANG ['member_编辑'] = '编辑企业';
$LANG ['member_group_编辑'] = '编辑企业组';
$LANG ['member_group_delete'] = '删除企业组';
$LANG ['member_model_export'] = '导出企业模型';
$LANG ['member_model_sort'] = '企业模型排序';
$LANG ['member_model_move'] = '移动模型企业';
...
$LANG ['view_memberlinfo'] = '查看企业信息';
$LANG ['move_content'] = '移动内容';
$LANG ['广告模板权限设置'] = '广告模板权限设置';
$LANG ['poster_template'] = '广告模板权限设置';
$LANG ['create_index'] = '生成首页';
...
$LANG ['wap_add'] = '添加站点';
$LANG ['wap_delete'] = '删除';
$LANG ['wap_type_编辑'] = '分类编辑';
$LANG ['wap_type_delete'] = '分类删除';
$LANG ['info_setting'] = '信息模型权限设置';
$LANG ['tag'] = '标签向导';
$LANG ['add_tag'] = '添加标签向导';
$LANG ['编辑_tag'] = '修改标签向导';
...
$LANG ['setdefaulttpl'] = '权限设置默认模板';
$LANG ['priv_setting'] = '权限权限设置';
...
$LANG ['member_manage'] = '待审核企业';
$LANG ['member_manage_list'] = '待审核企业';
$LANG ['huiyuans'] = '待审核企业';
$LANG ['sss'] = '其他企业';
$LANG ['member_manage_diy'] = '其他企业';
$LANG ['member_shenhe_diy'] = '待审核企业';
$LANG ['member_add'] = '添加企业';
$LANG [' '] = '项目与产品';
$LANG ['project'] = '项目信息';
$LANG ['project_info'] = '项目信息';
$LANG ['project_manager'] = '项目信息';
$LANG ['project_check'] = '市里审核';
$LANG ['content'] = '内容';
$LANG ['删除'] = '删除';
$LANG ['member'] = 'member';
$LANG ['编辑'] = '编辑';
$LANG ['content1111'] = '通过审核';
$LANG ['产品管理'] = '产品管理';
$LANG ['产品审核'] = '产品审核';
$LANG ['产品列表'] = '产品列表';
$LANG ['产品审核'] = '产品审核';
$LANG ['edit'] = '编辑';
$LANG ['项目添加'] = '项目添加';
$LANG ['chanyeleib'] = '产业类别';
$LANG ['yuanquconfig'] = '园区配置';
$LANG ['menuid'] = '园区配置';
$LANG ['editinfo'] = '个人信息';
$LANG ['editpwd'] = '密码修改';
$LANG ['联动表单删除'] = '联动表单删除';
...
$LANG ['member'] = '企业edit';
$LANG ['member'] = '企业edit';
$LANG ['member_move'] = '企业move';
$LANG ['member_list'] = '全部企业';
$LANG ['member_list'] = '全部企业';
$LANG ['member_add'] = '用户添加+';
$LANG ['member_edit'] = '企业edit';
$LANG ['member_modules'] = '企业模型配置';
$LANG ['member_modules'] = '管理企业模型';
$LANG ['member_setting'] = '企业模块管理';
$LANG ['systemconf'] = '系统配置';
$LANG ['project'] = '项目信息';
$LANG ['project_list'] = '项目列表';
$LANG ['project_check'] = '市里审核';
$LANG [' '] = '项目信息';
$LANG ['项目类别配置'] = '项目类别配置';
$LANG ['project_edit'] = '项目编辑';
$LANG ['project_check'] = '市里审核';
$LANG ['project_check2'] = '市里审核';
$LANG ['系统'] = '系统';
$LANG ['news_center'] = '消息中心';
$LANG ['news_center_1'] = '消息中心';
$LANG['member_manages'] = '待审核企业';
$LANG['member_check'] = '待审核企业';
$LANG['index'] = '首页';
$LANG['index_index'] = '首页';
$LANG['index_index_index'] = '首页';
$LANG['pruducts'] = '产品管理';
$LANG['products_list'] = '产品列表';
$LANG['member_dashi'] = '企业生产情况';
$LANG['month_dashi'] = '企业生产情况';
$LANG['project_check'] = '市里审核';
$LANG['project_check1'] = '项目审核';
$LANG['check_qianx'] = '审核权限';
$LANG['products_check'] = '产品审核';
$LANG['project_progress'] = '企业项目进度';
$LANG['project_progress1'] = '企业项目进度';
$LANG['project_top'] = '综合信息';
$LANG['manage_member_1'] = '用户管理';
$LANG['yuanqu_member'] = '园区用户';
$LANG['quxian_member'] = '区县用户';
$LANG['member_check_c'] = '待审核企业';
$LANG['member_manage_diy_m'] = '其他企业';
$LANG['tet'] = 'teset';
$LANG['info_application'] = '企业信息修改管理';
$LANG['info_application2'] = '修改申请';
?>