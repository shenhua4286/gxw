...
<div class="pad-10">
    <div class="col-tab">
        <ul class="tabBut cu-li">
            <li id="tab_swf_1" <?php echo $tab_status?> class="on" onclick="SwapTab('swf','on','',5,1);"><?php echo L('upload_attachment')?></li>
       	 <!-- 
         ...
         <div id="div_swf_1" class="content pad-10 ">
        	<div>
                ...
                <input style="display: none;" type="checkbox" id="watermark_enable" value="1" <?php if(isset($watermark_enable) &&$watermark_enable == 1) echo 'checked'?> onclick="change_params()">
                <!-- <div style="color:red;">
                	请点击选择文件，选择好本地文件后，点击开始上传
                </div>
                 -->
        	</div> 	
    		<div class="bk10"></div>
...
setInterval("swfu.startUpload()",1000);
