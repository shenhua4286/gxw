...
$LANG['allow_contributor'] = '在前台录入中显示';
...
$LANG['reject_message'] = '您的提交的项目被退回，请修改后重新提交';
$LANG['click_edit'] = '点击这里修改';
$LANG['reject_message_tips'] = '您提交的项目没有通过审核，请重新编辑提交！<BR>标题：';
$LANG['nocheck_users'] = '免审核人员';
$LANG['checkstatus_flag'] = '审核状态时是否允许修改';
$LANG['content_page'] = '内容页';
$LANG['reject_msg'] = '请输入审核不通过理由，不通过理由将会以短消息方式发送！';
...
$LANG['member_content_add'] = '企业中心信息添加模板：';
