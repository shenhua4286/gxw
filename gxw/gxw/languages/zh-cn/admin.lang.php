...
/*Language Format:
Add a new file(.lang.php) with your module name at /gxw/languages/
translation save at the array:$LANG
*/

//index
$LANG['admin_site_title'] = '长沙市工业信息化项目调度系统--后台管理中心';
$LANG['expand_or_contract'] = '展开与收缩';
$LANG['gxw_title'] = 'gxw内容管理系统';
...
$LANG['main_safety_permissions'] = '※ 建议您将gxw目录设置为755（linux）或只读（windows），<a href="http://www.phpip.com/html/2014/changjianwenti_0430/133.html" target="_blank">点击查看教程</a>';
...
$LANG['main_product_team'] = 'gxw系统开发团队';
...
$LANG['between_2_to_20'] = '应该为4-50位之间';
...
<B>互联网新闻开放协议：</B> <br>
1、互联网新闻开放协议》是百度新闻搜索制定的搜索引擎新闻源收录标准，网站可将发布的新闻内容制作成遵循此开放协议的XML格式的网页（独立于原有的新闻发布形式）供搜索引擎索引。 gxw可自动生成网站的Sitemaps，但是您还需要向google或者baidu提交Sitemaps的访问地址。<br>
您的网站的Sitemaps 访问地址为：<?=APP_PATH?>sitemaps.xml<br>
gxw可自动生成网站的<<互联网新闻开放协议>>，但是您还需要向baidu提交访问地址。<br>
...
$LANG['domain_name_format'] = '域名可为空，格式应该为http://www.gxw.cn/';
$LANG['domain_end_string'] = '格式应该为http://www.gxw.cn/，请以‘/’结束';
...
$LANG['group_private'] = '企业组权限';
$LANG['group_name'] = '企业组名称';
$LANG['allow_vistor'] = '允许访问';
$LANG['allow_contribute'] = '允许录入';
$LANG['contribute_add_point'] = '录入奖励';
$LANG['contribute_add_point_tips'] = '点 （企业在此栏目发表信息时可以得到的点数，为负数时减积分）';
$LANG['default_readpoint'] = '默认收取';
$LANG['readpoint'] = '点';
$LANG['readpoint_tips'] = '（企业在此栏目下查看信息时，该信息默认的收费），当这里设置为0时，发布页设置了，可只对设置的文章收费，<font color="red">生成静态时收费无效</font>';
$LANG['money'] = '元';
...
$LANG['site_domain_ex'] = '请填写域名，格式为：http://www.gxw.cn/';
$LANG['site_domain_ex2'] = '格式应该为http://www.gxw.cn/，请以‘/’结束';
...
$LANG['workflow'] = '工作流';
$LANG['dbsource'] = '数据源';
$LANG['member_group'] = '企业列表';
$LANG['membermodel'] = '企业模型';
$LANG['member_model_field'] = '企业模型字段';
