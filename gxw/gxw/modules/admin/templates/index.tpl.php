...
<div class="header">
	<!-- <div class="logo lf"><a href="<?php echo $currentsite['domain']?>" target="_blank"><span class="invisible"><?php echo L('gxw_title')?></span></a></div> -->
    <div class="rt-col" style="visibility:hidden;">
    	<div class="tab_style white cut_line text-r"><a href="javascript:;" onclick="lock_screen()"><img src="<?php echo IMG_PATH.'icon/lockscreen.png'?>"> <?php echo L('lockscreen')?></a><span>|</span><a href="http://www.gxw.cn" target="_blank">gxw</a><span>|</span><a href="http://www.gxw.cn/license/license.php" target="_blank"><?php echo L('authorization')?></a><span>|</span><a href="http://bbs.gxw.cn" target="_blank"><?php echo L('igenus_for_postfix')?></a><span>|</span><a href="http://v9.help.gxw.cn/" target="_blank"><?php echo L('help')?></a>
    <ul id="Skin">
    ...
    "><span>
    	...
    	<div class="log white cut_line" >
    		...
    		<!--
    		 <a  style="visibility:hidden;" href="<?php echo $currentsite['domain']?>" target="_blank" id="site_homepage"><?php echo L('site_homepage')?></a><span>|</span>
    		<a style="visibility:hidden;" href="?m=search" target="_blank" id="site_search"><?php echo L('search')?></a>
    		 -->
    	</div>
        ...
        foreach($array as $_value) {
        	if($_value['id']=='1623') {
        		...
        		echo '<li id="_M'.$_value['id'].'" class="top_menu"><a href="javascript:_M('.$_value['id'].',\'?m='.$_value['m'].'&c='.$_value['c'].'&a='.$_value['a'].'\')"  hidefocus="true" style="outline:none;">'.L($_value['name']).'<font color="red" style="position:relative;top:-8px;"><b id="remind_user"></b></font></a></li>';
        	}else if($_value['id']=='1614'){
        		echo '<li id="_M'.$_value['id'].'" class="top_menu"><a href="javascript:_M('.$_value['id'].',\'?m='.$_value['m'].'&c='.$_value['c'].'&a='.$_value['a'].'\')"  hidefocus="true" style="outline:none;">'.L($_value['name']).'<font color="red" style="position:relative;top:-8px;"><b id="remind_info"></b></font></a></li>';
        	}else {
...
*/
	//默认载入左侧菜单
	$("#leftMain").load("?m=admin&c=index&a=public_menu_left&menuid=1623");
...
function com_remind(){
	$.ajax({
		type:"get",
		url:"?m=admin&c=index&a=com_remind",
		dataType:'json',
...
//未审核项目和产品的数目
function zonghe_remind(){
	$.ajax({
		type:"get",
		url:"?m=admin&c=index&a=zonghe_remind",
		dataType:'json',
		success:function(data){
			if(data.success){
				if(data.msg==0){
...
com_remind();
zonghe_remind();
setInterval("com_remind()",3600);
setInterval("zonghe_remind()",3600);
//站点选择
...
function show_help(targetUrl) {
	$("#help").slideUp("slow");
	var str = '';
	$.getJSON("http://v9.help.gxw.cn/api.php?jsoncallback=?",{op:'help',targetUrl: targetUrl},
	function(data){
		if(data!=null) {
			$("#help").slideDown("slow");
