...
<div class="table-list">
    <table width="100%" cellspacing="0">
		...
		<th width="10%">ID</th>
		<th width="10%" align="left"  class="gxw_link_name"><?php echo L('linkage_name')?></th>
...
$(function(){
	var em=$(".content-menu").find("em");
	var em2Text=$(em[1]).text();
	if(em2Text){
		em2Text=em2Text.replace("配置","");
		$(em[0]).text("添加"+em2Text);
	}
	//console.log($(em).text());
});
