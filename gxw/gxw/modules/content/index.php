...
class index {
	...
	function __construct() {
		...
		$this->_status = param::get_cookie('_status');
	}
	//首页
	public function init() {
		...
		include template('member','index',$default_style);
	}
	
	public function touch(){
		include template('content','touch');
	}	
	...
	public function show() {
		...
		$memberinfo['groupid']=$_groupid;
		$memberinfo['username']=$_username;
		$memberinfo['nickname']=$_username;
		$memberinfo['nickname']=$this->_nickname;
