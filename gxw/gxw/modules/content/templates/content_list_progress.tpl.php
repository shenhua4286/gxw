...
<div class="table-list">
    <table width="100%">
        <thead>
			...
			<th width="100">所属月份</th>
            <th width="200">所属企业</th>
            <th width="70">月完成投资(万元)</th>
            <th width="100">存在问题</th>
            <th width="100">形象进度</th>
...
<tbody>
	...
	?>
		...
		<td align="left">
		 ...
		 -->
		<td align='align' ><?php echo $r['id'];?></td>
		<td align='align' >
			<?php echo "<a href='index.php?m=content&c=content&a=edit&isShow=1&catid=12&id={$r['projectId']}&pc_hash={$_SESSION['pc_hash']}'>{$r['projectTitle']}</a>";?>
		</td>
		 <td>
			<?php echo $r['yearMonth']?>
		</td>
		<!--  
		...
		?></td>
		<td align='right'><?php echo $r['monthCompleteDz']?></td>
		<td align='left'><?php echo str_cut($r['question'],20)?></td>
		<td align='left'><?php echo str_cut($r['progress'],20)?></td>
