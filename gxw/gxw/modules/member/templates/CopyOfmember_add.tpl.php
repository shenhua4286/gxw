...
<fieldset>
	...
	<table width="100%" class="table_form">
		...
		<tr>
			<td><?php echo L('nickname')?>(园区/区县)</td> 
		...
		<tr style="display: none;">
			...
			<td>
			<input type="text" name="info[point]" value="10" class="input-text" id="point" size="10"></input>
			</td>
		</tr>
			<input type="hidden" name="info[modelid]" value="12"/>
		<!-- <tr>
