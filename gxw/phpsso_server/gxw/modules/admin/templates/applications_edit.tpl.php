...
<table width="100%"  class="table_form">
  ...
  <tr>
   ...
   <tr>
	...
	<option value="gxw_v9"<?php if ($data['type']=='gxw_v9'){echo ' selected';}?>>gxw_v9</option>
    <option value="gxw_2008_sp4"<?php if ($data['type']=='gxw_2008_sp4'){echo ' selected';}?>>gxw_2008_sp4</option>
