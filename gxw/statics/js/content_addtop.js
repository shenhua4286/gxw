...
function change_images(uploadid,returnid){
	...
	$.each( contents, function(i, n) {
		...
		str += "<li style='float:left;margin-top:12px;position:relative;width:124px;height:124px;margin-right:10px;margin-bottom:10px;' id='image"+ids+"'><input type='hidden' name='"+returnid+"_url[]' value="+n+" /><img name='"+returnid+"_url[]' src='"+n+"' style='width:124px;' ondblclick='image_priview(this.value);' class='input-text'> <a style='position:absolute;left:0;bottom:5px;width:124px;text-align:center; background-color:#000; background-color: rgba(0, 0, 0, 0.85);color:#fff;' href=\"javascript:remove_div('image"+ids+"')\">移除</a> </li>";
		});
